...
public class Controls {
	...
	public Controls() {
		...
		xLimiter      = new SlewRateLimiter(24); // -6 to 6 in two seconds
		yLimiter      = new SlewRateLimiter(24); // -6 to 6 in two seconds
		rotateLimiter = new SlewRateLimiter(12 * Math.PI);
