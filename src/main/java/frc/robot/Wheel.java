...
public class Wheel {
	...
	******************************************************************************************/
	public void setDriveMotorPower(double power) {
		...
		if ((name == Drive.WheelProperties.FRONT_LEFT_WHEEL) || (name == Drive.WheelProperties.REAR_LEFT_WHEEL)) {
	...
	******************************************************************************************/
	public double getEncoderValue() {
		...
		if ((name.equals(Drive.WheelProperties.FRONT_LEFT_WHEEL)) || (name.equals(Drive.WheelProperties.REAR_LEFT_WHEEL))) {
			tempValue *= -1;
		}
